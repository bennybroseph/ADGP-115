...
namespace Units
{
    ...
    public class UserControllerMotion : MonoBehaviour
    {
        [SerializeField]
       ...
       public void Move(Vector3 move, bool viewIsLocked = false, bool crouch = false, bool jump = false)
        {
            m_ViewIsLocked = viewIsLocked;
        ...
        private void UpdateAnimator(Vector3 move)
        {
            ...
            m_Animator.SetBool("ViewIsLocked", m_ViewIsLocked);
        ...
        public void OnAnimatorMove()
        {
            ...
            if (m_IsGrounded && Time.deltaTime > 0)
            {
                if (m_ViewIsLocked)
                {
                    m_Rigidbody.velocity = m_Velocity * 5.6f;
